...
\begin{figure}[h!tb]
    ...
    \end{tikzpicture}
   \caption{%
       Simulierte  Strom-Spannungs-Kurve eines  Moduls mit  einer degradierten
       Zelle.%    Oberes   Diagramm: Simulierte  Strom-Spannungs-Kurve   eines
       Moduls  aus 72  Zellen  (in Serie  geschaltet)  mit einer  degradierten
       Zelle\protect\\
...
\begin{figure}[h!tb]
   ...
   \caption{%
       ...
       Modulen mit einem degradierten Modul.\protect\\
       \textbf{\textcolor{blue}{blau}}: Alle   Module  geben   volle  Leistung
        ab.\protect\\
