...
\begin{figure}[h!tb]
    ...
    \end{tikzpicture}
   \caption{%
       Simulierte   Strom-Spannungs-Kurve  eines   Strangs  von   Modulen  mit
       einem  degradierten   Modul. Die  zuge\"orige  \code{LTspice}-Schaltung
       ist in  Abbildung \ref{fig:ltspice:vicurvesimulator:modules}  auf Seite
