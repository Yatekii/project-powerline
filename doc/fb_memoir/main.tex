...
\include{mainmatter/uberblick}
\include{mainmatter/models}
\include{mainmatter/simu}
\include{mainmatter/hardware}
\include{mainmatter/hardware-sensor}
\include{mainmatter/hardware-master}
\include{mainmatter/software}
\include{mainmatter/firmware-sensor}
\include{mainmatter/software-master}
\include{mainmatter/validierung}
\include{mainmatter/userguide}
\include{mainmatter/fazit}
...
\appendixpage
\appendix
%\include{appendices/celldata}
%\include{appendices/simu-modul-simple}
\include{appendices/commercial-modules}
\include{appendices/ltspice}
\include{appendices/schema}
\include{appendices/validierung}
\include{appendices/costs}
%\include{appendices/models}            % DEPRECATED
%\include{appendices/simu-modul}        % DEPRECATED
%\include{appendices/simu-complementary}
