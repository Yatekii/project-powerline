...
\begin{figure}[h!tb]
    ...
    \caption{%
        ...
        Spannung   am  Empf\"anger   (Knoten  \code{receiever}   in  Abbildung
...
Besitzt die  angeschlossene Last  zus\"atzlich noch  parasit\"are Kapazit\"at, wie
...
\begin{figure}[h!tb]
    \input{images/simu-capacitive/tran-Cload.tex}
    \caption{%
        ...
        am     Empf\"anger    (Knoten     \code{receiever}    in     Abbildung
...
\begin{figure}[h!tb]
    \input{images/simu-short/short-simple.tex}
    \caption{%
