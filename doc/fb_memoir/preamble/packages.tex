...
\usepackage[textsize=footnotesize, textwidth = 25mm, german, colorinlistoftodos]{todonotes}
\usepackage{calc}            % used for calculating margins and widths for A3 pages
\usepackage{caption}         % captions outside float environments
