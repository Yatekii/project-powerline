/* Auto-generated config file hpl_sysctrl_v202_config.h */
#ifndef HPL_SYSCTRL_V202_CONFIG_H
#define HPL_SYSCTRL_V202_CONFIG_H
...
#    define CONF_DFLLVAL   SYSCTRL_DFLLVAL_COARSE(							 \
			(( CONF_DEFAULT_CORASE ) == 0x3F ) ? 0x1F : ( CONF_DEFAULT_CORASE ))	  \
	|																 \
	SYSCTRL_DFLLVAL_FINE(512)										 \

#else
#    define CONF_DFLLVAL   SYSCTRL_DFLLVAL_COARSE(CONF_DFLL_COARSE) |		  \
	SYSCTRL_DFLLVAL_FINE(CONF_DFLL_FINE)							 \
...
#endif         // HPL_SYSCTRL_V202_CONFIG_H
