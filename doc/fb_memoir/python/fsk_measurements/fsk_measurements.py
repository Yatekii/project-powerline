...
plt.ylim([-250, 250])
plt.legend(['$L_1(f)$', '$L_{1stray}(f)$', '$L_multi(f)$'], loc='upper left')
...
#plt.ylim([-250, 250])
plt.legend(['$L_{inc}(\int Udt)$', '$L_{sec}(\int Udt)$'], loc='upper left')
