...
\footnotetext{%
    ...
    Ressourcen massiv  \"ubersteigen. Daher werden  sie f\"ur den  Rest dieses
    Berichts nicht ber\"ucksichtigt.%
}
...
Strang  abgegebene  Leistung  um  etwa einen  Viertel  \todo{nicht  abgegebene
Leistung verheizt?}.
...
nur schwach  abgeschattet oder  verschmutzt sind  \todo{weshalb?}. Solange die
...
des   Wechselrichters\todo{Nicht  GAK?}. Das   schlichte  Hutschienengeh\"ause
erm\"oglicht   eine   einfache   Installation    in   bestehende   oder   neue
Schaltschr\"anke. Die  Energieversorgung,  wie  auch  die  Ankopplung  an  die
DC-Leitungen   erfolgt  im   Innern   Schaltschrankes  und   wird  von   einem
