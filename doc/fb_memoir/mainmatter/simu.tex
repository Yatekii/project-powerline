...
Form  sehr  schwach   verzerrt,  was  wir  als  einen   sehr  positiven  Punkt
...
\begin{figure}[h!tb]
    ...
    {%
        ...
        \code{LTspice}   wird    ein   eigenes   Symbol   f\"ur    ein   Modul
...
oszilliert bei  durchgeschaltetem Transistor ungefh\"ar  um den im  Mittel vom
...
kurze Zeit sogar beinahe \SI{600}{\watt} ab und der MOSFET absorbiert mehr als
