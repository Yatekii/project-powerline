...
\begin{figure*}[ht!]
  ...
  \begin{bytefield}{32}
    ...
    \begin{rightwordgroup}{\sffamily Adresse}
        \colorbitbox{solarized-base2}{solarized-base02}{32}{Adressbyte 0} \\
        \colorbitbox{solarized-base2}{solarized-base02}{32}{Adressbyte 1} \\
        \colorbitbox{solarized-base2}{solarized-base02}{32}{Adressbyte 2} \\
        \colorbitbox{solarized-base2}{solarized-base02}{32}{Adressbyte 3}
    \end{rightwordgroup} \\
    \colorbitbox{solarized-magenta}{solarized-base3}{16}{Spannung}
    \colorbitbox{gray!50}{black}{16}{Nicht verwendet}\\
    \colorbitbox{solarized-blue}{solarized-base3}{32}{CRC}\\
  \end{bytefield}
