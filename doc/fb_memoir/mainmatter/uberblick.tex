...
wie  auch   die  Ankopplung  an   die  DC-Leitungen  erfolgt  im   Innern  des
Schaltschrankes und wird von einem Elektroinstallateur ausgef\"uhrt.
...
\begin{figure}[h!tb]
    \centering
    \input{images/python/modulation.pgf}
