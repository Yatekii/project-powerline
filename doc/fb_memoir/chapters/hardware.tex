...
% HARDWARE SENSOR
% ---------------------------------------------------------------------------- %
\input{chapters/hardware-sensor.tex}
...
aus dem Datenblatt \cite{ref:lm2596}  f\"ur unsere Konfiguration.\todo{C1, C2,
D5, L1} $L1 = \SI{22}{\micro\henry}$, $C_2: output capacitor$
...
\adjustbox{valign=t}{\begin{minipage}{0.25\textwidth}
    ...
    \figcaption[\Master: Schema Einkopplung]{Anschl\"usse zur Einkopplung}
...
Chip, verbunden mit \code{Vcc\_B} auf dem Pegelwandler) zu wandeln.\todo{check
values}
