...
iterativ  in   \code{LTspice}. Es  wird   die  Schaltung   gem\"ass  Abbildung
...
Wobei \code{IS} der \emph{Reverse Saturation Current} \todo{Deutscher Begriff}
und \code{N}  der Idealit\"atsfaktor  ist. Der Reverse Saturation  Current ist
...
\"ublicherweise  Bereicht  von   Nano-Amp\`ere  bis  Femto-Amp\`ere\todo{F\"ur
k\"aufliche  Dioden,  nicht  Solarzellen}.   Der  Idealit\"atsfaktor  ist  ein
...
zeigt dies schematisch.\todo{Pfeile auf Achsen}
