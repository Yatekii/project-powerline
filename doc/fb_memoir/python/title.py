...
ax1.plot(t_lo_1, fsk_mod_lo_ld(t_lo_1), label=r"Tr\"agerfrequenz", color='blue', agg_filter=GaussianFilter)
ax1.plot(t_hi_1, fsk_mod_hi_ld(t_hi_1), label=r"Tr\"agerfrequenz", color='blue', agg_filter=GaussianFilter)
ax1.plot(t_lo_2, fsk_mod_lo_ld(t_lo_2), label=r"Tr\"agerfrequenz", color='blue', agg_filter=GaussianFilter)
plt.rc('lines', linewidth=2)
ax1.plot(t_lo_1, fsk_mod_lo_ld(t_lo_1), label=r"Tr\"agerfrequenz", color='red')
ax1.plot(t_hi_1, fsk_mod_hi_ld(t_hi_1), label=r"Tr\"agerfrequenz", color='red')
ax1.plot(t_lo_2, fsk_mod_lo_ld(t_lo_2), label=r"Tr\"agerfrequenz", color='red')
ax1.set_ylim([-1.1 * A2, 1.1 * A2])
ax1.set_xlim([0,12*T])

fig1.subplots_adjust(bottom=0.0,top=1,left=0,right=1)
