...
\begin{figure}[h!tb]
    ...
    \caption{
        Verhalten  eines  Moduls  bei  Reduktion des  Stroms  einer  einzelnen
        Zelle.%
    }
...
\begin{figure}[h!tb]
    ...
    \caption{
        Verhalten  eines Modulstrangs  ohne Freilaufdioden  bei Reduktion  des
        Stroms einer einzelnen Zelle.%
    }
...
\begin{figure}[h!tb]
    ...
    \caption{
        Verhalten eines Modulstrangs mit einer Freilaufdiode f\"ur jedes Modul
        bei Reduktion des Stroms einer einzelnen Zelle.%
    }
    \label{fig:simu:iv-curves:array:generic:bypass}
\end{figure}

%\input{data/iv-curves/calculations.tex}
%
%\begin{figure}[h!tb]
%    \input{images/iv-curves/module.tex}
%    \caption{%
...
%\end{figure}
%\begin{figure}[h!tb]
%    \input{images/iv-curves/array.tex}
%    \caption{%
