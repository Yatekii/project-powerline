...
% ---------------------------------------------------------------------------- %
    ...
    \noindent\adjustbox{valign=t}{\begin{minipage}{135mm}
        ...
        Features mitbringt. Der Mikrochip hat einen 12 Bit-ADC, ein CRC-Modul,
        eine 32 Bit ARM-Architektur und braucht extrem wenig Leistung.
        ...
        74HC4640  Chip von  Texas Instruments  (Bereich 2).   Dieser kann  mit
        der richtigen  Beschaltung Frequenzen  zwischen wenigen  Kilohertz bis
        mehreren Megahertz erzeugen.
        ...
        Im Folgenden  sind die einzelnen Teilschaltungen  dokumentiert und die
        Komponentenwahl ihre Wahl begr\"undet.
...
gew\"ahlt, wie es die Graphen  im Datasheet \todo{Source Datasheet} zeigen. Es
wurde  eine  Frequenz  von  \SI{20}{\mega\hertz} ausgew\"ahlt,  da  diese  bei
Leitungen unserer  L\"ange optimal sind\todo{Weshalb?}.  Das  Signal wird dann
...
Programmierschnittstelle (SWD).\todo{datenblatt source}
...
Am Sensor sind zwei LEDs und ein Schalter angebracht, welche zu Statusanzeigen
